    ...
    <div className="min-h-screen bg-gradient-to-br from-blue-50 to-indigo-100 flex items-center justify-center px-4 sm:px-6 lg:px-8">
      <div className="max-w-md w-full space-y-8 bg-white rounded-2xl shadow-xl p-8">
        <div className="text-center">
          <h1 className="text-3xl font-bold text-gray-900">🇦🇺 Findery</h1>
        ...
        <form className="mt-8 space-y-6" onSubmit={handleSubmit(onSignIn)}>
          ...
          >
            <svg className="w-5 h-5 mr-2" viewBox="0 0 24 24">
              ...
              <path fill="#EA4335" d="M12 5.38c1.62 0 3.06.56 4.21 1.64l3.15-3.15C17.45 公用 2.09 14.97 1 12 1 7.7 1 3.99 3.47 2.18 7.07l3.66 2.84c.87-2.6 3.3-4.53 6.16-4.53z"/>
            </svg>
            Sign in with Google
          </button>

          <div className="text-center">
            <a href="/business/login" className="text-sm text-blue-600 hover:text-blue-500">
